...
export const userDummyData = {
  ...
  image:
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRCQYkZMzIdVVTyBFD3pMCS58AGtH5d288zEg&s",
  role: "hotelOwner",
  isVerified: true,
  isBlocked: false,
...
export const roomsDummyData = [
  {
    ...
    images: [
      { url: roomImg1, public_id: "roomImg1-1" },
      { url: roomImg2, public_id: "roomImg2-1" },
      { url: roomImg3, public_id: "roomImg3-1" },
      { url: roomImg4, public_id: "roomImg4-1" },
    ],
    isAvailable: true,
  ...
  },
  {
    ...
    amenities: ["Room Service", "Mountain View", "Pool Access"],
    images: [
      { url: roomImg2, public_id: "roomImg2-2" },
      { url: roomImg3, public_id: "roomImg3-2" },
      { url: roomImg4, public_id: "roomImg4-2" },
      { url: roomImg1, public_id: "roomImg1-2" },
    ],
    isAvailable: true,
  ...
  },
  {
    ...
    images: [
      { url: roomImg3, public_id: "roomImg3-3" },
      { url: roomImg4, public_id: "roomImg4-3" },
      { url: roomImg1, public_id: "roomImg1-3" },
      { url: roomImg2, public_id: "roomImg2-3" },
    ],
    isAvailable: true,
  ...
  },
  {
    ...
    images: [
      { url: roomImg4, public_id: "roomImg4-4" },
      { url: roomImg1, public_id: "roomImg1-4" },
      { url: roomImg2, public_id: "roomImg2-4" },
      { url: roomImg3, public_id: "roomImg3-4" },
    ],
    isAvailable: true,
